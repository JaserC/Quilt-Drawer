...
export type Row = {kind: "rnil"} | {kind: "rcons", hd: Square, tl: Row};

/** The empty list of squares. */
export const rnil: {kind: "rnil"} = {kind: "rnil"};
...
export type Quilt= {kind: "qnil"} | {kind: "qcons", hd: Row, tl: Quilt};

/** The empty list of rows. */
export const qnil: {kind: "qnil"} = {kind: "qnil"};
